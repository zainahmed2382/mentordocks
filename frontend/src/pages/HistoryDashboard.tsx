                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 space-y-2">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {isRecent && (
                              <span className="text-[9px] font-bold font-mono bg-blue-500/10 border border-blue-500/20 text-blue-400 px-1.5 py-0.5 rounded uppercase tracking-wider shrink-0">
                                Latest
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <button
                            ...
                            title="Re-run audit"
                            className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600/10 hover:bg-blue-600/20 border border-blue-500/20 hover:border-blue-500/40 text-blue-400 text-xs font-bold rounded-xl transition cursor-pointer"
                          >
